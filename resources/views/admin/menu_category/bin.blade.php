...
<div class="content-wrapper" style="min-height: 1302.4px;">
    <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Menu Categories Recycle Bin</h1>
            </div>
            <div class="col-sm-6">
      ...
      <section class="content">
        ...
        <div class="row">
          ...
          <div class="card">
                ...
                <a href="{{route('menucategory.index')}}"><button type="button"class="btn btn-info">Manage Menu Categories</button></a>
                </div>
                </div>
...
<tr class="odd">
                      ...
                      <td>{{$menucategory['slug']}}</td>
                        <td><img src="{{asset('uploads/'.$menucategory['image'])}}" alt="{{$menucategory['title']}}" width="100px" height="100px"></td>
                      ...
                      <td>
                        ...
                        <a href="{{route('menucategory.restore',$menucategory->id)}}"><button type="button"class="btn btn-warning">Restore</button></a>
