    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="card-header d-flex justify-content-end">
              ...
              <a href="{{route('filemanager.index')}}"><button type="button"class="btn btn-info">Manage Files</button></a>
              </div>
...
@foreach ($filemanager as $data)
                  ...
                  <tr class="odd">
                    ...
                    <a href="{{route('filemanager.restore',$data['id'])}}"><button type="button" class="btn btn-warning">Restore</button></a>
