      ...
      <section class="content">
        ...
        <div class="row">
          ...
          <div class="card">
                ...
                <a href="{{route('menuitem.index')}}"><button type="button"class="btn btn-info">Recycle Bin</button></a>
                </div>
                </div>
...
<tr class="odd">
                    ...
                    <td>
                        ...
                        <a href="{{route('menuitem.restore',$menuitem->id)}}"><button type="button"class="btn btn-warning">Restore</button></a>
