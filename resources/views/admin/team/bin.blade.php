      ...
      <section class="content">
        ...
        <div class="row">
          ...
          <div class="card">
                ...
                <a href="{{route('team.index')}}"><button type="button"class="btn btn-info">Manage Team Members</i></button></a>
                </div>
                </div>
...
<tr class="odd">
                      ...
                      <td>
                        ...
                        <a href="{{route('team.restore',$team->id)}}"><button type="button"class="btn btn-warning">Rstore</button></a>
