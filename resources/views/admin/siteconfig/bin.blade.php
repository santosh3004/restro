...
<div class="content-wrapper" style="min-height: 1302.4px;">
  <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Site Configs Recycle Bin</h1>
          </div>
          <!-- <div class="col-sm-6">
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="card-header d-flex justify-content-end">
              ...
              <a href="{{route('siteconfig.index')}}"><button type="button"class="btn btn-info">Manage Site Configs</button></a>
              </div>
...
@foreach ($siteConfig as $scs)
                  ...
                  <tr class="odd">
                    ...
                    <td>
                      ...
                      <a href="{{route('siteconfig.restore',$scs['id'])}}"><button type="button"class="btn btn-warning">Restore</button></a>
