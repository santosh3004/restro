...
<div class="content-wrapper" style="min-height: 1302.4px;">
    <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Blog Categories Recycle Bin</h1>
            </div>
            <div class="col-sm-6">
      ...
      <section class="content">
        ...
        <div class="row">
          ...
          <div class="card">
                ...
                <a href="{{route('blogcategory.index')}}"><button type="button"class="btn btn-info">Manage Blog Category</button></a>
                </div>
                </div>
...
<tr class="odd">
                      ...
                      <td>
                        ...
                        <a href="{{route('blogcategory.restore',$blogcats->id)}}"><button type="button"class="btn btn-warning">Restore</button></a>
